import { Paragraph, Accordion, UnorderedList } from "@amsterdam/design-system-react"
  ...
  <>
    ...
    <Accordion headingLevel={3}>
      <Accordion.Section label="Wat gebeurt er bij het importeren van verzonden vve-brieven?">
        <UnorderedList>
          <UnorderedList.Item>
            Bij een match met een vve wordt een contactmelding aangemaakt. Deze is terug te vinden in het communicatieoverzicht van deze vve. Er wordt maar één contactmelding aangemaakt per vve, ongeacht hoe vaak deze voorkomt in het bronbestand.
          </UnorderedList.Item>
          <UnorderedList.Item>

  ...
  <>
    <Accordion headingLevel={3}>
      <Accordion.Section label="Wat gebeurt er bij het importeren van cursusdeelnemers?">
        <UnorderedList>
          ...
          <UnorderedList.Item>
            Een import kan altijd opnieuw worden uitgevoerd. Reeds geïmporteerde
            contacten worden niet opnieuw aangemaakt.
          </UnorderedList.Item>
        </UnorderedList>
      </Accordion.Section>
    </Accordion>
    ...
    <Accordion headingLevel={3}>
      <Accordion.Section label="Welke kolommen moet het document bevatten?">
        ...
        <UnorderedList>
          <UnorderedList.Item>
            <strong>naam</strong>: Volledige naam van de cursusdeelnemer
          </UnorderedList.Item>
          <UnorderedList.Item>
            <strong>email</strong>: E-mailadres van de cursusdeelnemer
          </UnorderedList.Item>
          <UnorderedList.Item>
